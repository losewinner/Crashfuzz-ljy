...
public class QueueEntry {
    ...
    public int getPerfScore() {
		//ljy--这里一共提到了几种打分标准
		//1. exec_s和avg_exec_us: 该Queue对象，一轮测试的执行时间与平均执行时间的对比
		//2. bitmap_size和avg_bitmap_size：该Queue对象，一轮测试的覆盖率和平均覆盖率的对比
		//3. handicap：等待测试的轮数，等待轮数越多，说明该让他上一上测试了
		//4. fault_size: 故障序列中包含的故障点的数量也有关系
